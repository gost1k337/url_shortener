...
func (s *UrlShortGrpcService) Create(ctx context.Context, req *proto.CreateUrlShortRequest) (*proto.CreateUrlShortResponse, error) {
...
func (s *UrlShortGrpcService) Get(ctx context.Context, req *proto.GetUrlShortRequest) (*proto.GetUrlShortResponse, error) {
